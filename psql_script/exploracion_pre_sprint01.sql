/* 
Describimos brevemente la base de datos 
*/

SELECT 	* 
	FROM 	information_schema.columns 
	WHERE 	"table_name" = 'uba_kenedy';
    
/*
Seleccionamos los registros en el rango de fechas establecido: 01/9/2020 al 01/02/2021
*/
...
Seleccionamos los siguientes campos: 
    ...
    emails (email),
    para el rango de fechas establecido
*/
